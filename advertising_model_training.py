...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "udemy-mlops-474821.ml_ops.advertising_roi_model_metrics"
...
def save_model(model):
    ...
    bucket = storage_client.bucket("nhegde-mlops")
...
def main():
    ...
    campaign_file_path = "gs://nhegde-mlops/advertising_roi/campaign_spend.csv"
    df_spend = read_campaign_data(campaign_file_path)

    revenue_file_path = "gs://nhegde-mlops/advertising_roi/monthly_revenue.csv"
